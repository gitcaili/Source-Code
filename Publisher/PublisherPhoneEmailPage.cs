...
namespace NZPACRM
{
    public class PublisherPhoneEmailPage : Web
    {
        ...
        string sUseAreaCode = "";
        #endregion 
        public PublisherPhoneEmailPage()
        {
        ...
        public override void BuildContents()
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(Dispatch.EitherField("pbls_PublishersID")))
                    iEntityRecordID = Convert.ToInt32(Dispatch.EitherField("pbls_PublishersID"));
                else
                    iEntityRecordID = Convert.ToInt32(Dispatch.EitherField("Key58"));


                Record objEntityIdRec = FindRecord("custom_tables", "bord_name='Publishers' and bord_deleted is null ");
                ...
                if (!String.IsNullOrEmpty(Dispatch.EitherField("HiddenMode")))
                {
                    if (Dispatch.EitherField("HiddenMode") == "save")
                    {
                        ...
                        sURL += "/CustomPages/Publishers/PublishersSummary.asp?SID=" + Dispatch.EitherField("SID");
                        sURL += "&Key0=58&F=&J=Publishers/PublishersSummary.asp&pbls_PublishersID=" + iEntityRecordID + "&T=Publishers";
                ...
                string sCancelURL = Url("Publishers/PublishersSummary.asp") + "&pbls_PublishersID=" + iEntityRecordID;
