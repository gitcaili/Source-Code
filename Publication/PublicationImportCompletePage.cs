...
namespace NZPACRM
{
    public class PublicationImportCompletePage : Web
    {
        CRMHelper objCRM = new CRMHelper();
        public PublicationImportCompletePage()
        {
        ...
        public override void BuildContents()
        {
            try
            {
                ...
                if (Fail != "Fail" || Fail == "")
                {
                    ...
                    objCRM.GetStatusBlock("Publications", StatusMsg, "Success");
                    #endregion
                ...
                {
                    StatusMsg = "Error while importing Publications data. Kindly make sure that you have selected proper Import template.";
                    #region Get Client template block
                    objCRM.GetStatusBlock("Publications", StatusMsg, "Error");
                    #endregion
