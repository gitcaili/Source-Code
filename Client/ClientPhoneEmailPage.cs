...
namespace NZPACRM
{
    public class ClientPhoneEmailPage : Web
    {
        ...
        public override void BuildContents()
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(Dispatch.EitherField("client_ClientID")))
                    iEntityRecordID = Convert.ToInt32(Dispatch.EitherField("client_ClientID"));
                else
                ...
                if (!String.IsNullOrEmpty(Dispatch.EitherField("HiddenMode")))
                {
                    ...
                    {                        
                        ...
                        sURL += "/CustomPages/Client/ClientSummary.asp?SID=" + Dispatch.EitherField("SID");
                        sURL += "&Key0=58&F=&J=Client/ClientSummary.asp&client_ClientID=" + iEntityRecordID + "&T=Client";
                ...
                string sCancelURL = Url("Client/ClientSummary.asp") + "&client_ClientID=" + iEntityRecordID;
