...
{
    public class RateCardImportStatus : Web
    {
        CRMHelper objCRM = new CRMHelper();
        string shttpURL = "";

        public RateCardImportStatus()
        {
            ...
            try
            {
                ...
                if (sRowCount == "Y")
                {
                    ...
                    if (isValidColumn == "")
                    {
                        ...
                        {
                            sStatusMsg += iSucessCount + " Rate Card record(s) imported in Sage CRM. For more details, click on Show Logs button." + "<br />";
                        }
                ...
                objCRM.GetRateCardStatusBlock("Rate Card", sStatusMsg, isValidColumn, sRowCount);
                #endregion
