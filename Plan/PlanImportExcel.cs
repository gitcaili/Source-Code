...
{
    public class PlanImportExcel : DataPageNew
    {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(Dispatch.ContentField("HIDDEN_Save")))
                {
                    if (Dispatch.ContentField("HIDDEN_Save") == "Save")
                    {
                        ...
                        try
                        {
                         ...
                         //   AddContent("agent" + agentcy);
                            ...
                            int bid = 0;
                           string weekjo = (string)(mWSheet1.Cells[22, 5] as Microsoft.Office.Interop.Excel.Range).Text;
                         //   AddContent("CAT" + contact);

                            char[] delimiterChars2 = { ' ', ',', '.', ':', '\t' };
                          // AddContent(");
                            string[] weeks2 = weekjo.Split(delimiterChars2);
                            string name = "" + agentcy + " " +  d1.Year.ToString();
                            //AddContent(weeks2.Length.ToString());
                            weekcurr = Int32.Parse(weeks2[1]);
                         //   AddContent(weekcurr.ToString());
                            //  DateTimeFormatInfo dfi = DateTimeFormatInfo.CurrentInfo;

                            //  Calendar cal = dfi.Calendar;
                            // AddContent((cal.GetWeekOfYear(d1, dfi.CalendarWeekRule, dfi.FirstDayOfWeek)).ToString() + "JODM");
                            string strSQL = "select * from Booking where book_Agency =(Select comp_CompanyId from Company where Comp_Name like '" + agentcy + " and comp_deleted is null') and book_CampaignSummary = '" + Camp + "' and book_Deleted is null and book_costingversion = '" + weekjo + "'";
                       ...
                       //     AddContent(bid.ToString());
                          ...
                          //       AddContent(" P.O.P2 ");
                             ...
                             //    AddContent(strSQL2);
                                ...
                                string[] parms = new string[] { "book_Name", "book_Agency", "book_Contact", "book_Client", "book_CampaignSummary", "book_costingversion", "book_status", "book_agencycode", "book_docversion", "book_reference", "book_version"};
                                string[] values = new string[] { name, comp, pid, cid, Camp, weekjo, "InProgress", agentcode,"1",GenerateSequecenumber(""), iVersionNo.ToString() };
                            ...
                            string weektemp = (string)(mWSheet1.Cells[22, 5] as Microsoft.Office.Interop.Excel.Range).Value;
                            char[] delimiterChars = { ' ', ',', '.', ':', '\t' };
                            string[] weeks = weektemp.Split(delimiterChars);
                            weekcurr = Int32.Parse(weeks[1]);
                          //  AddContent(mWSheet1.UsedRange.Rows.Count.ToString());
                            for (int j = 22; j < mWSheet1.UsedRange.Rows.Count + 2; j++)
                               //for (int j = 22; j < 40; j++)
                            {
                              ...
                              //  AddContent(j.ToString());
                                string eventPlan = (string)(mWSheet1.Cells[j,2] as Microsoft.Office.Interop.Excel.Range).Value; ;
                              //  string quoteR = (string)(mWSheet1.Cells[j, 3] as Microsoft.Office.Interop.Excel.Range).Value;
                               ...
                               AddContent("BOOKED2");
                                string week = (string)(mWSheet1.Cells[j,5] as Microsoft.Office.Interop.Excel.Range).Value;
                               AddContent("BOOKED3");
                                string status = (string)(mWSheet1.Cells[j,6] as Microsoft.Office.Interop.Excel.Range).Value;
                                AddContent("CAT " + week + " blov" );
                            ...
                            //    AddContent("BOOKED");
                              ...
                              AddContent("DAY");
                                ...
                                AddContent("Insert");
                                string size = (string)(mWSheet1.Cells[j,12] as Microsoft.Office.Interop.Excel.Range).Value;
                                string size2 = StandardSizeCode(size);
                               AddContent("HELl");
                               ...
                               AddContent("COOOROR");
                                string cost = "";
                                if (!String.IsNullOrEmpty(((string)(mWSheet1.Cells[j, 15] as Microsoft.Office.Interop.Excel.Range).Value)))
                                {
                                    cost = (string)(mWSheet1.Cells[j, 15] as Microsoft.Office.Interop.Excel.Range).Value.ToString();
                                }
                                if (color == "Colour" || color == "COLOUR") color = "COLOR";
                                else color = "NoColor";
                                AddContent("BEES");
                                string key = "";
                               if (!String.IsNullOrEmpty(((string)(mWSheet1.Cells[j, 16] as Microsoft.Office.Interop.Excel.Range).Value.ToString())))
                                 key = (string)(mWSheet1.Cells[j, 16] as Microsoft.Office.Interop.Excel.Range).Value.ToString();
                           ...
                           //     AddContent("KEY");
                                ...
                                if (!String.IsNullOrEmpty(((string)(mWSheet1.Cells[j, 17] as Microsoft.Office.Interop.Excel.Range).Text).Trim()))
                                  caption = (string)(mWSheet1.Cells[j,17] as Microsoft.Office.Interop.Excel.Range).Value;
                                if (!String.IsNullOrEmpty(((string)(mWSheet1.Cells[j, 18] as Microsoft.Office.Interop.Excel.Range).Text).Trim()))
                                    special = (string)(mWSheet1.Cells[j,18] as Microsoft.Office.Interop.Excel.Range).Value;
                              ...
                              //  size = size.Replace(" ", string.Empty);
                                ...
                                char[] delimiterChars4 = { ' ', ',', '.', ':', '\t' };
                                 weeks = week.Split(delimiterChars4);
                                if (Int32.Parse(weeks[1]) != weekcurr)
                                {

                                    weekcurr = Int32.Parse(weeks[1]);
                                    AddContent("FLAT");
                                    Boolean newplan2 = true;
                                    string strSQLbook = "select * from Booking where book_Agency =(Select comp_CompanyId from Company where Comp_Name like '" + agentcy + " and comp_deleted is null') and book_CampaignSummary = '" + Camp + "' and book_costingversion ='" + week + "' and book_Deleted is null and  book_name = '" + name + "' and book_stage <> 'Closed'";
                                    QuerySelect objCurrencyRecbook = GetQuery();
                                    objCurrencyRecbook.SQLCommand = strSQLbook;
                                    objCurrencyRecbook.ExecuteReader();
                                    if (!objCurrencyRecbook.Eof())
                                    {
                                        //string sbid = objCurrencyRecbook.FieldValue("book_Bookingid").ToString();
                                        //bid = Int32.Parse(sbid);
                                        //bid2 = bid;
                                        //newplan2 = false;
                                        ...
                                        newplan = false;
                                        AddContent(sbid);
                                        string sdoc = objCurrencyRecbook.FieldValue("book_docversion").ToString();
                                        AddContent("HAT " + sdoc + "DOC");
                                        AddContent("AMIRIGHT");
                                        int docnew = Int32.Parse(sdoc);
                                        ...
                                        version.SaveChanges();
                                        newBook.SaveChanges();
                                        AddContent("AMIWRONG3");
                                        newBook.SaveChanges();
                                        int newbid = newBook.RecordId;
                                        copyplanbuilders(bid.ToString(), newbid.ToString());
                                        bid = newbid;
                                        AddContent("AMIWRONG4");
                                        string wfid = "13";
                                        string curren = "10234";
                                        string currstate = "55";

                                        AddContent("AMIWRONG5");
                                        string WriteEntity = "WorkFlowInstance";
                                        parms = new string[] { "WkIn_WorkflowId", "WkIn_CurrentEntityId", "WkIn_CurrentRecordId", "WkIn_CurrentStateId" };
                                        values = new string[] { wfid, curren, bid.ToString(), currstate };
                                        Record WFRecord = new Record(WriteEntity);
                             ...
                             //           AddContent(strSQL2);
                                        ...
                                        //string name = "" + agentcy;
                                        string WriteEntity = "Booking";
                                        string[] parms = new string[] { "book_Name", "book_Agency", "book_Contact", "book_Client", "book_CampaignSummary", "book_costingversion", "book_status", "book_agencycode","book_reference", "book_docversion", "book_version" };
                                        string[] values = new string[] { name, comp, pid, cid, Camp, week, "InProgress", agentcode,GenerateSequecenumber(""), "1", iVersionNo.ToString() };
                         ...
                         //       AddContent("RAT");
                                ...
                                string SQLRate = "Select * from RatesCard where rate_PublicationsID = '" + pubid + "' and rate_commissiontype = '" + comtype + "' and rate_Section = '" + secid + "' and rate_Day like '%" + dayshort + "%' and rate_standardsize = '" + size2 + "' and rate_client = '413' and rate_color = '" + color + "'";
                                if (subsecid != "") SQLRate += "and rate_subsectionid = '" + subsecid + "'";
                                ...
                                if (day.Equals("Thursday")) dayuse = day;
                                else dayuse = dayshort;
                                if (secid.Equals("")) { plancheck = "select * from PlanBuilder where pnbr_plan = " + bid + " and pnbr_week = '" + Int32.Parse(weeks[1]) + "'and pnbr_Publications = " + pubid + " and pnbr_sections is null and pnbr_day = '" + dayuse + "' and pnbr_Deleted is null"; }
                                else { plancheck = "select * from PlanBuilder where pnbr_plan = " + bid + " and pnbr_week = '" + Int32.Parse(weeks[1]) + "'and pnbr_Publications = " + pubid + " and pnbr_sections = '" + secid + "' and pnbr_day = '" + dayuse + "' and pnbr_Deleted is null"; }
                                ...
                                {
                                    string pbid = (string)((mWSheet1.Cells[j, 21] as Microsoft.Office.Interop.Excel.Range).Value.ToString());
                                    ...
                                    if (r.GetFieldAsString("pnbr_action") == "Booked" || r.GetFieldAsString("pnbr_action") == "Amend")
                                    {
                                    ...
                                    r.SaveChanges();
                                    mWSheet1.Cells[j, 21] = r.RecordId.ToString();
                                ...
                                else if (status.Equals("change") || status.Equals("Change") || status.Equals("CHANGE"))
                                {
                                    ...
                                    if (insertiondate.Year != old.Year && insertiondate.Month != old.Month && insertiondate.Day != old.Day && (r.GetFieldAsString("pnbr_action") == "Booked" || r.GetFieldAsString("pnbr_action") == "Amend"))
                                    {
                                        ...
                                        string[] planprams = new string[] { "pnbr_color", "pnbr_days", "pnbr_plan", "pnbr_publications", "pnbr_sections", "pnbr_size", "pnbr_Standardsize", "pnbr_week", "pnbr_ratecard", "pnbr_cost", "pnbr_commissiontype", "pnbr_note", "pnbr_action", "pnbr_date", "pnbr_keynumber", "pnbr_subsection", "pnbr_standardrate" };
                                        string[] planvalues = new string[] { color, day, bid.ToString(), pubid, secid, "standard", size2, weeks[1], Rateid, rateamount, comtype, caption, "amend", insertiondate.ToString(), key, subsecid, rateamount };
                                        ...
                                        mWSheet1.Cells[j, 21] = plannbuildid.ToString();
                                    ...
                                    {
                                        string[] prams = new string[] { "pnbr_color", "pnbr_days", "pnbr_plan", "pnbr_publications", "pnbr_sections", "pnbr_size", "pnbr_Standardsize", "pnbr_week", "pnbr_ratecard", "pnbr_cost", "pnbr_commissiontype", "pnbr_note", "pnbr_action", "pnbr_date", "pnbr_keynumber", "pnbr_subsection", "pnbr_standardrate", "pnbr_total" };
                                        string[] updat = new string[] { color, day, bid.ToString(), pubid, secid, "standard", size2, weeks[1], Rateid, rateamount, comtype, caption, "amend", insertiondate.ToString(), key, subsecid, rateamount,rateamount };
                                    ...
                                    {
                                        string[] prams = new string[] { "pnbr_color", "pnbr_days", "pnbr_plan", "pnbr_publications", "pnbr_sections", "pnbr_size", "pnbr_Standardsize", "pnbr_week", "pnbr_ratecard", "pnbr_cost", "pnbr_commissiontype", "pnbr_note","pnbr_date", "pnbr_keynumber", "pnbr_subsection", "pnbr_standardrate","pnbr_total" };
                                        string[] updat = new string[] { color, day, bid.ToString(), pubid, secid, "standard", size2, weeks[1], Rateid, rateamount, comtype, caption, insertiondate.ToString(), key, subsecid, rateamount,rateamount };
                              ...
                              //      AddContent("!" + caption + "!");
                                    ...
                                    string[] planprams = new string[] { "pnbr_color", "pnbr_days", "pnbr_plan", "pnbr_publications", "pnbr_sections", "pnbr_size", "pnbr_Standardsize", "pnbr_week", "pnbr_ratecard", "pnbr_total", "pnbr_commissiontype", "pnbr_Note","pnbr_date","pnbr_keynumber","pnbr_subsection", "pnbr_standardrate" };
                                    string[] planvalues = new string[] { color, day, bid.ToString(), pubid, secid, "standard", size2, weeks[1], Rateid, rateamount, comtype, caption,insertiondate.ToString(),key,subsecid,rateamount };
                               ...
                               //         AddContent(i.ToString());
                                ...
                                else
                                {
                                    ...
                                    if (r.GetFieldAsString("pnbr_action") == "Booked")
                                    {
                            ...
                            mWorkBook.SaveAs(GetLibraryPath() + @"Plan\" + "Warehouse.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlOpenXMLWorkbook,
                   ...
                   Missing.Value, Missing.Value);
                            ...
                            AddContent(GetLibraryPath() + @"Plan\" + "Warehouse.xlsx");
                            getSMTPDetails();
                            getSMPTPassword();
                            SendEmail();
                        ...
                        {
                            string sURL = shttpURL + "//" + Dispatch.Host + "/" + Dispatch.InstallName + "/eware.dll/Do";
                            sURL += "?SID=" + Dispatch.EitherField("SID") + "&Act=432&dotnetdll=EnablingCRM&dotnetfunc=RunPlanImportStat&inserted=" + InsertCount + "&name=" + bid2;
                          //  Dispatch.Redirect(sURL);
        ...
        public void SendEmail()
        {
            ...
            msg.Subject =  "Warehouse News Works Plan" + DateTime.Now.ToShortDateString();
            sb.Append("<br>");
           ...
           // AddContent("Attaching");
            ...
            string sFileName = GetLibraryPath() + @"Plan\" + "Warehouse.xlsx";
